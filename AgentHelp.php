...
$Email=$value[0];   
$AgentHelpTextArea=$_POST['AgentHelpTextArea'];
...
$sql="insert into agentshelp(Email,Help)
...
?>
  ...
  <div id="wrapper">
    ...
    <textarea class="form-control"  name="AgentHelpTextArea"id="exampleFormControlTextarea1" rows="6" style="width:100%"></textarea>
                      <br>
