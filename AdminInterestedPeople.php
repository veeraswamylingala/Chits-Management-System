...
<br><br>
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Interested People</h1>
...
$sql = "SELECT * FROM interestedpeople";
    ...
    if(mysqli_num_rows($result) > 0){
              ...
              echo "<td>" . $row['Plan']. "</td>";
                echo "<td>" . $row['Message']. "</td>";
                  echo "<td> "?>    
        <button type="button" value="$row['Slno']" class="btn btn-success" name="ConfirmButton" style="float: Center; ">Confirm</button><?php
                      "</td>"
