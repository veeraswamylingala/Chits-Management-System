...
$Email=$value[0];   
$AgentHelpTextArea=$_POST['AgentReportTextArea'];
...
$sql="insert into agentsreports(Email,Report)
values('$Email','$AgentHelpTextArea')";
...
?>
  ...
  <div id="wrapper">
    ...
    <textarea class="form-control" name="AgentReportTextArea"id="exampleFormControlTextarea1" rows="6" style="width:100%"></textarea>
                      <br>
