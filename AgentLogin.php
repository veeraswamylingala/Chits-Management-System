...
$sql="select Email,Password from agentstable";
    ...
    background-attachment: fixed;
        ...
        <center>  
            <div class="container" style="">
             ...
             <h4 style="margin-left:100px;margin-top:20px;color:white"> Agent Log-In</h4>
              ...
              <button type="submit" class="btn btn-success" name="AgentLoginButton" style="float: right;background-color:green;Margin-top:10px; ">Login</button>
              
                    
                    
                    
                    <a href=""> <label style="float:left;margin-top:10px;">Request a Passsword Reset</label></a>
                 </div>         
            </div>
                </div>
            </center>
