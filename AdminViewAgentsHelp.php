...
<br><br>
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Agent Help Request</h1>
...
if($result = mysqli_query($link, $sql)){
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        <button type="button" class="btn btn-success" style="float: Center; ">Reply</button>
